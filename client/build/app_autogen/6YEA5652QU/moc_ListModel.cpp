/****************************************************************************
** Meta object code from reading C++ file 'ListModel.hpp'
**
...
#include <memory>
#include "../../../include/ListModel.hpp"
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'ListModel.hpp' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_StringListModel_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_StringListModel_t qt_meta_stringdata_StringListModel = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_StringListModel[] = {
...
Q_CONSTINIT const QMetaObject StringListModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_StringListModel.offsetsAndSizes,
